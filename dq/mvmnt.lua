...
--[[
    ...
    - GUI visibility controlled by config.visibility
--]]
...
local config = {
    ...
    isPlaying = false,
    visibility = true -- new config for GUI visibility
}
...
-- Set GUI visibility based on config after autoplay logic
gui.Enabled = config.visibility
